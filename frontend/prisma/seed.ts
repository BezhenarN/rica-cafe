...
async function main() {
  ...
  // ── Пицца 35см ─────────────────────────────────────────────────────────────
  const pizzas = [
    { slug: 'chetyre-syra', name: 'Четыре сыра', description: 'Крем-чиз, моцарелла, чеддер, горгонзола, дорблю', price: 750 },
    { slug: 'frutti-de-mare', name: 'Фрутти Де Море', description: 'Сливочный соус, лосось, креветка, кальмар, моцарелла, черри, руккола', price: 790 },
    { slug: 'tom-yum', name: 'Том Ям', description: 'Крем-чиз, паста том ям, моцарелла, креветки, мидии, кальмар, семга, шампиньоны, перец чили, руккола', price: 888 },
    { slug: 'vetchina-griby', name: 'Ветчина — грибы', description: 'Сливочный соус, грибы шампиньоны, сыр моцарелла, ветчина из куриных грудок, микс зелени', price: 690 },
    { slug: 'dolche', name: 'Дольче', description: 'Сливочный соус, сыр моцарелла, сервелат по-фински, ветчина из куриных грудок, мясо цыплёнка, шампиньоны, томаты черри, микс зелени', price: 710 },
    { slug: 'slivochnyy-losos', name: 'Сливочный лосось', description: 'Крем-чиз, моцарелла, лосось, томаты, руккола', price: 810 },
    { slug: 'riino', name: 'Рино', description: 'Сливочный соус, сыр моцарелла, шампиньоны, пепперони, ветчина из куриных грудок, сервелат, болгарский перец, микс зелени', price: 695 },
    { slug: 'puljeze', name: 'Пульезе', description: 'Соус Рино, сладкий лук, маслины, каперсы, томаты черри, пармезан, моцарелла, сладкий перец, артишоки', price: 680 },
    { slug: 'rica', name: 'Рица', description: 'Крем-чиз, моцарелла, шампиньоны, куриная грудка, томаты черри, базилик', price: 720 },
    { slug: 'pepperoni', name: 'Пепперони', description: 'Крем-чиз, моцарелла, пепперони, пармезан, шампиньоны, томаты', price: 710 },
    { slug: 'napolitano', name: 'Неаполитано', description: 'Соус Рино, моцарелла, сулугуни, вяленые томаты, руккола', price: 680 },
    { slug: 'myasnaya', name: 'Мясная', description: 'Томатный соус Рино, моцарелла, пепперони, бекон, куриная грудка, маслины', price: 780 },
    { slug: 'meksikanskaya', name: 'Мексиканская', description: 'Сливочный соус, острый фирменный соус, шампиньоны, бекон, черри, зелень', price: 680 },
    { slug: 'margarita', name: 'Маргарита', description: 'Соус Рино, розовые томаты, моцарелла, сулугуни, базилик', price: 650 },
    { slug: 'karbonara', name: 'Карбонара', description: 'Сливочный соус, сыр моцарелла, бекон, ветчина куриная, яичный желток, пармезан', price: 700 },
    { slug: 'kaprichoza', name: 'Капричоза', description: 'Сливочный соус, шампиньоны, оливки, маслины, артишоки, пармезан, томаты черри, базилик, ветчина из курицы', price: 720 },
    { slug: 'grusha-gorgonzola', name: 'Груша-горгонзола', description: 'Сливочный соус, сыр моцарелла, горгонзола, груша, руккола, мёд', price: 750 },
    { slug: 'gribnaya', name: 'Грибная', description: 'Крем-чиз, моцарелла, шампиньоны, грибы', price: 650 },
    { slug: 'vetchina-gribi', name: 'Ветчина-грибы', description: 'Сливочный соус, грибы шампиньоны, сыр моцарелла, ветчина из куриных грудок, микс зелени', price: 690 },
    { slug: 'bismark', name: 'Бисмарк', description: 'Фирменный соус Рино, ветчина из курицы, бекон, черри, пармезан, куриный желток', price: 720 },
  ];
